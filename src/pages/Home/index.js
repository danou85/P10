...
import ModalEvent from "../../containers/ModalEvent"; // Importer ModalEvent
...
const Page = () => {
  ...
  // On récupère le dernier événement, et si les données sont vides, on met un objet par défaut
  const eventDefault = {
    cover: "",
    title: "",
    date: new Date(),
        ...
        <section className="ServicesContainer" id="nos-services">
          ...
          <div className="ListContainer">
            ...
            <ServiceCard imageSrc="/images/hall-expo.png">
              ...
              sa taille, en s’adaptant à vos demandes. En tant que spécialistes
              de l’événementiel, nous saurons trouver le lieu parfait ainsi que
          ...
          <Modal key={last.id} Content={<ModalEvent event={last} />}>
            {({ setIsOpened }) => (
              <EventCard
                ...
                small
                label={last.type} // Fournir une étiquette par défaut
              />
            )}
          </Modal>
        </div>
